...
(function($) {
    ...
    const locale = {
        "zh-TW": {
            ...
            "HTML5_VIDEO_CONTROL_INTRO": "在貼文以及連續短片中顯示 HTML5 影片控制器。\n\n這將會隱藏自訂影片音量滑條，並由 HTML5 控制器取代。\n在連續短片頁面中，HTML5 控制器可以透過右鍵點擊影片來隱藏，以顯示原始詳細資訊。",
            ...
            "DIRECT_DOWNLOAD_VISIBLE_RESOURCE_INTRO": "直接下載貼文中的目前資源。",
        ...
        "zh-CN": {
            ...
            "HTML5_VIDEO_CONTROL_INTRO": "在帖子和 Reels 中显示 HTML5 视频控制器。\n\n这将隐藏自定义视频音量滑块并将其替换为 HTML5 控制器。\n在 Reels 页面中，可以通过右键单击视频来隐藏 HTML5 控制器以显示原始详细信息。",
            ...
            "DIRECT_DOWNLOAD_VISIBLE_RESOURCE_INTRO": "直接下载帖子中的当前资源。",
        ...
        "ro": {
            ...
            "SETTING": "Setări",
            "AUTO_RENAME": "Redenumește automat fișierele (Click dreapta pentru a seta)",
            "RENAME_SHORTCODE": "Redenumește fișierul și include cod scurt",
            "RENAME_PUBLISH_DATE": "Setează marcajul de timp al fișierelor redenumite la data publicării resurselor",
            ...
            "DIRECT_DOWNLOAD_VISIBLE_RESOURCE": "Descarcă direct resursele vizibile din postare",
            ...
            "DIRECT_DOWNLOAD_VISIBLE_RESOURCE_INTRO": "Descarcă direct resursele actuale din postare.",
